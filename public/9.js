...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    notificationColor: function notificationColor() {
  ...
  filters: {
    getDateForHumans: function getDateForHumans(value) {
      return moment(value).locale(vue__WEBPACK_IMPORTED_MODULE_0___default.a.i18n.locale()).subtract(-2, 'hours').fromNow();
    },
          ...
          _c(
            ...
            [
              _c(
                "v-avatar",
                [
                  _c("v-icon", { attrs: { color: _vm.notificationColor } }, [
